...
public class RandomItemSpawn : MonoBehaviour
{
    ...
    public void SpawnObjects()
    {
        ...
        for (int i = 0; i < spawnPoints.Length; i++)
        {
            if (i == 2)
            {
                Instantiate(items[0], items[Random.Range(0, items.Length)].transform);
            ...
            {
                Instantiate(items[1], items[Random.Range(0, items.Length)].transform);
            ...
            else if (i != 1 || i != 2)
            {
                ...
                Instantiate(items[randomItem], spawnPoints[randomSpawn].transform);
